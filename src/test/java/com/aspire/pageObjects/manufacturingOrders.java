...
public class manufacturingOrders extends BaseClass {
    ...
    public void removeManufacturingOrderInSearch() {
        waitForElementToAppear(xdriver, ManufacturingOrderInSearch, 10);
    ...
    public void setSearchTextField(String orderno) {
        ...
        waitForElementToAppear(xdriver, ManufacturingOrderNo, 10);
    }
